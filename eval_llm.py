...
def main():
	...
	parser.add_argument(
		'--num_hidden_layers', default=8, type=int, help='隐藏层数量（Small/MoE=8, Base=16）'
	)
	parser.add_argument(
	...
	parser.add_argument(
		'--temperature', default=0.85, type=float, help='生成温度，控制随机性（0-1，越大越随机）'
	)
	parser.add_argument('--top_p', default=0.85, type=float, help='nucleus采样阈值（0-1）')
	parser.add_argument(
		'--historys', default=0, type=int, help='携带历史对话轮数（需为偶数，0表示不携带历史）'
	)
